    ...
    <div className='flex justify-between align items-center w-full p-2 px-40'>
      ...
      <div className='md:flex lg:flex md:gap-12 lg:gap-12'>
        ...
        <ul className='hidden md:flex lg:flex items-center gap-2 md:gap-6 lg:gap-6'>
           ...
           <li className='text-[16px] font-normal text-main'>Home</li>
           <RiArrowDropDownLine size={30} className='text-main'/>
            ...
            <li className='text-[16px] font-normal text-secondary'>Shop</li>
        ...
        {isOpen && (
            ...
            <li className='menuLink hover:text-blue-900'>Home</li>
             <li className='menuLink hover:text-blue-900'>Products</li>
              <li className='menuLink hover:text-blue-900'>Blog</li>
              <li className='menuLink hover:text-blue-900'>Shop</li>
              <li className='menuLink hover:text-blue-900'>Contact</li>
            </ul>
          </div>
