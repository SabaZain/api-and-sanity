...
const Cart = ({ setShowCart}:CartProps) => {
    ...
    return(
        <div className="w-full min-h-screen fixed top-0 z-20 overflow-y-scroll">
            <div className="max-w-[400px] w-full min-h-full bg-gray-600 absolute right-0 top-0 p-6 mr-6 md:mr-0 lg:mr-0">
                <RxCross1
                ...
                <div className="text-center text-[18px] text-red-700 font-semibold">
