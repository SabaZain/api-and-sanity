  ...
  return (
    <div>
        ...
        <div>
            ...
            <p className='text-sm md:text-md lg:text-md text-start font-normal px-14 text-slate-400 mt-3'>Welcome to our website! We offer a wide range of high quality and stylish chairs and sofas that can elevate<br/>
      ...
      <p className='text-sm md:text-md lg:text-md text-start font-normal px-14 text-slate-400 mt-3'>Please leave your message here, and we will
